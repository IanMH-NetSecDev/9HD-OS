...
3. Download and run the install script using the command `curl -fsSL - "https://raw.githubusercontent.com/IanMH-NetSecDev/9HD-OS/refs/heads/latest/stub" | bash`. Replace "latest" with your desired version (like prerelease-v0.1) if you'd like a specific release.
