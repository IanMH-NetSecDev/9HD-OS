...
crypto-partitioner-fail(){
    ...
    if [[ "$RestartPartitioner" == "ABORT" ]]; then #abort
        ...
        echo "This section not yet completed. Please restart script."
        abort-install #FUTURE ADDITION (P1): replace this with call to proceed function
    else
