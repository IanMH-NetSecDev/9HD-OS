...
curl -fsSL -o "$InstallerScriptPath" https://raw.githubusercontent.com/IanMH-NetSecDev/9HD-OS/refs/heads/prerelease-v0.1/Assets/9HDOS_Installer_v0.1_Local.sh
chmod +x "$InstallerScriptPath"
curl -fsSL -o "$ChrootScriptPath" https://raw.githubusercontent.com/IanMH-NetSecDev/9HD-OS/refs/heads/prerelease-v0.1/Assets/9HDOS_chroot_v0.1.sh
